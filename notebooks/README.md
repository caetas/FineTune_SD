...
This should allow you to directly import `src/finetune_sd` in your notebook.
...
Run `python -m ipykernel install --user --name="finetune_sd"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called finetune_sd should be available in the
